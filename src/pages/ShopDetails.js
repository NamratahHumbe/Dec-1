...
function ShopDetails() {
  return (
                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner border">
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src="assets/img/product-1.jpg" alt="img"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src="assets/img/product-2.jpg" alt="img"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src="assets/img/product-3.jpg" alt="img"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src="assets/img/product-4.jpg" alt="img"/>
                        </div>
                    </div>
    ...
    <TrandyProduct name='You may also like'/>
    </div>
  )
}
